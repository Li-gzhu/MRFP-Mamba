...
class EftR(nn.Module):
    def __init__(self, layers_ret1, ffn1,heads1,
        ...
        # hidden_dim1 = math.ceil((channels+32) / n_groups[0]) * n_groups[0]
        ...
        # self.retnet2 = RetNet( layers_ret2, hidden_dim, ffn2*hidden_dim, heads2, double_v_dim=False)
    ...
    def forward(self, X):
        ...
        # X = self.retnet1(X)
        X = self.tokenizer(X)  # batch,L, hiddem_dim

...
class MDCP(nn.Module):
    ...
    def __init__(self, img_size=16, patch_size=3, in_chans=3, embed_dim=256, dataset="Houston"):
        super().__init__()
        ...
        if dataset == "PaviaU":
            ...
            groups_width = 64
            channels = 274#103
            # self.pool = nn.AdaptiveAvgPool3d((40, 15, 15))#PU
...
class DCTN(nn.Module):
    ...
    def __init__(self, layers, img_size=15, patch_size=3, in_chans=3, num_classes=1000,
        ...
        #self.conv3d =nn.Conv3d(in_channels=1, out_channels=105, kernel_size=(144, 1, 1))

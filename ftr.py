...
class FTR(nn.Module):
    def __init__(self, layers_ret=1,
                 hidden_dim=None, ffn=None, heads=None, dim1=None,
        ...
        self.list_retnet = {"layers": layers_ret, "hidden_dim": hidden_dim, "ffn_size": ffn, "heads": heads,
